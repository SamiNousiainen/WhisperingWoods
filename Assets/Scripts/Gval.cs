...
public static class Gval {
    ...
    //public static readonly string feedbackEmail = "tarinatalo.mpf@gmail.com";
	...
	//public static readonly LayerMask lightDestroyableLayer = LayerMask.NameToLayer("LightDestroyable");
